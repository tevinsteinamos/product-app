...
function getSignedCodeVersion(signedCode) {
  ...
  var _signedCode$split2 = _slicedToArray(_signedCode$split, 2);

  var _ = _signedCode$split2[0];
  var versionComment = _signedCode$split2[1];
...
function verifySignedCode(signedCode) {
  ...
  var hashComment = _signedCodeLines[0];
  ...
  var _ = _hashMatches[0];
  var hash = _hashMatches[1];
