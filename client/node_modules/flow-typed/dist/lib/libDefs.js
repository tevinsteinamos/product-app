...
function parsePkgFlowDirVersion(pkgFlowDirPath, validationErrs) {
  ...
  var _1 = _matches[0];
  var isAll = _matches[1];
  var _2 = _matches[2];
  var range = _matches[3];
  var major = _matches[4];
  var minor = _matches[5];
  var patch = _matches[6];
  var upRange = _matches[7];
  var _3 = _matches[8];
  var upMajor = _matches[9];
  var upMinor = _matches[10];
  var upPatch = _matches[11];
...
function parseLibDefsFromPkgDir(_ref, pkgDirPath, validationErrs) {
  ...
  var pkgVersion = _ref.pkgVersion;
      ...
      switch (_context12.prev = _context12.next) {
        ...
        case 4:
          ...
          return regeneratorRuntime.awrap(P.all(flowDirs.map(function _callee5(_ref4) {
            ...
            var flowDirPath = _ref5[0];
            var flowVersion = _ref5[1];
...
function parseRepoDirItem(dirItemPath, validationErrs) {
  ...
  var _ = _itemMatches[0];
  var pkgName = _itemMatches[1];
  var major = _itemMatches[2];
  var minor = _itemMatches[3];
  var patch = _itemMatches[4];
    ...
    while (1) {
      switch (_context13.prev = _context13.next) {
        ...
        case 4:
          ...
          _context13.t2 = String(_context13.t1);
          metadata = _context13.t0.parse.call(_context13.t0, _context13.t2);
